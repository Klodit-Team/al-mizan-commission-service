...
export class CommissionMarcheController {
  ...
  findAll(@Query() query: PaginationQueryDto): Promise<PaginatedResponseDto<CommissionMarche>> {
    return this.service.findAll(query);
  }

  @Post()
  @ApiOperation({ summary: 'Créer une nouvelle commission de marché' })
  @ApiResponse({ status: 201, description: 'Commission de marché créée avec succès', type: CommissionMarche })
  ...
  @ApiResponse({ status: 200, description: 'Commission trouvée', type: CommissionMarche })
  ...
  @ApiParam({ name: 'id', description: 'UUID de la commission', type: String })
  @ApiResponse({ status: 200, description: 'Commission mise à jour', type: CommissionMarche })
  @ApiResponse({ status: 400, description: 'Données de validation invalides' })
  @ApiResponse({ status: 404, description: 'Commission introuvable' })
  @ApiResponse({ status: 401, description: 'Non autorisé — header X-User-Id manquant ou session invalide' })
  update(
  ...
  @ApiParam({ name: 'id', description: 'UUID de la commission', type: String })
  @ApiResponse({ status: 200, description: 'Statut mis à jour', type: CommissionMarche })
  ...
  @ApiParam({ name: 'id', description: 'UUID de la commission', type: String })
  @ApiResponse({ status: 200, description: 'Liste des membres', type: [MembreMarche] })
  @ApiResponse({ status: 404, description: 'Commission introuvable' })
  @ApiResponse({ status: 401, description: 'Non autorisé — header X-User-Id manquant ou session invalide' })
  ...
  @ApiParam({ name: 'id', description: 'UUID de la commission', type: String })
  @ApiResponse({ status: 201, description: 'Membre ajouté avec succès', type: MembreMarche })
  ...
  @ApiResponse({ status: 200, description: 'Membre mis à jour', type: MembreMarche })
  ...
  @ApiParam({ name: 'id', description: 'UUID de la commission', type: String })
  @ApiResponse({ status: 201, description: 'PV de délibération enregistré', type: CommissionMarche })
  @ApiResponse({ status: 400, description: 'Données invalides' })
  @ApiResponse({ status: 404, description: 'Commission introuvable' })
  @ApiResponse({ status: 401, description: 'Non autorisé — header X-User-Id manquant ou session invalide' })
  setDeliberation(
  ...
  @ApiResponse({ status: 404, description: 'Commission introuvable' })
  @ApiResponse({ status: 401, description: 'Non autorisé — header X-User-Id manquant ou session invalide' })
  getDeliberation(@Param('id', ParseUUIDPipe) id: string): Promise<{ pvDeliberation: string | null; commissionId: string }> {
  ...
  @ApiParam({ name: 'id', description: 'UUID de la commission', type: String })
  @ApiResponse({ status: 200, description: 'Marché attribué avec succès', type: CommissionMarche })
  @ApiResponse({ status: 400, description: 'Données invalides' })
  @ApiResponse({ status: 404, description: 'Commission introuvable' })
  @ApiResponse({ status: 401, description: 'Non autorisé — header X-User-Id manquant ou session invalide' })
  attribuerMarche(
