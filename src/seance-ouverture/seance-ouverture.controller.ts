...
@ApiHeader({
  name: 'X-User-Id',
  required: true,
  description: 'ID utilisateur (via Gateway)',
})
@ApiHeader({
  name: 'X-User-Roles',
  required: true,
  description: 'Rôles utilisateur (via Gateway)',
})
